...
<div class="account">
	...
	<div class="panel panel-default row">
		<div class="panel-body">
			<div class="col-sm-3">
				<img src="<?php  echo $_W['attachurl'];?>headimg_<?php  echo $account['acid'];?>.jpg?acid=<?php  echo $account['acid'];?>" alt="<?php  echo $account['name'];?>" class="img-rounded" onerror="this.src='resource/images/gw-wx.gif'" >
			</div>
			<div class="col-sm-7">
