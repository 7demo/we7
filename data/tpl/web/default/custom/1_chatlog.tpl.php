	...
	<div class="panel-body">
		<form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
			...
			<div class="form-group">
				...
				<div class="col-sm-6 col-md-8 col-lg-8">
					<select name="acid" class="form-control" id="acid">
						<option value="" selected="selected">请选择公众号</option>
						<?php  if(is_array($data)) { foreach($data as $da) { ?>
						<option value="<?php  echo $da['acid'];?>"<?php  if($_GPC['acid'] == $da['acid']) { ?> selected="selected"<?php  } ?>><?php  echo $da['name'];?></option>
						<?php  } } ?>
					</select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6 col-md-8 col-lg-8">
					<?php  echo tpl_form_field_date('starttime', date('Y-m-d H:i',$starttime), false)?>
