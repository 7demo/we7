			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12 ">
						<input type="text" class="form-control" readonly="readonly" value="<?php  echo $entry['url'];?>" />
						...
						<div class="panel panel-default reply-container" style="padding-top:2em;">
							<div ng-hide="entry.saved">
								...
								<div class="form-group">
									<label class="col-xs-12 col-sm-3 col-md-2 control-label">直接URL</label>
									<div class="col-sm-9 col-xs-12">
										<p class="form-control-static" style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><?php  echo $entry['url'];?></p>
									</div>
								</div>
							</div>
								...
								<div class="col-sm-8">
									<div class="panel panel-default">
										...
										<div class="panel-footer" style="border-top:0;">
											<a ng-href="{{'../app/' + entry.url}}" href="javascript:;" target="_blank" class="btn btn-defualt btn-block">查看原文</a>
										</div>
									</div>
								</div>
							</div>
