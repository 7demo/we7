...
<ol class="breadcrumb" style="padding:5px 0;">
	...
	<li class="active"><?php  if(!empty($rid)) { ?>编辑<?php  } else { ?>添加<?php  } ?><?php  echo $module['title'];?></li>
</ol>
<?php  } ?>
<ul class="nav nav-tabs">
	<li><a href="<?php  echo url('platform/reply', array('m' => $m));?>">管理<?php  echo $module['title'];?></a></li>
	<li<?php  if(empty($rid)) { ?> class="active"<?php  } ?>><a href="<?php  echo url('platform/reply/post', array('m' => $m));?>"><i class="fa fa-plus"></i> 添加<?php  echo $module['title'];?></a></li>
	<?php  if(!empty($rid)) { ?><li class="active"><a href="<?php  echo url('platform/reply/post', array('m' => $m, 'rid' => $rid))?>"><i class="fa fa-edit"></i> 编辑<?php  echo $module['title'];?></a></li><?php  } ?>
