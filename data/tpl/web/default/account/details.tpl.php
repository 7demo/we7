...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<span class="pull-right">
			<a href="<?php  echo url('account/bind/post', array('acid' => $account['acid'], 'uniacid' => $account['uniacid']))?>" class="img-rounded edit">编辑</a>&nbsp;&nbsp;
			<a href="<?php  echo url('account/bind/delete', array('acid' => $account['acid'], 'uniacid' => $account['uniacid']))?>" class="img-rounded delete" onclick="return confirm('此操作不可恢复，确认吗？'); return false;">删除</a>
		</span>
	</div>
	...
	<div class="panel-body" id="scroll">
		<div class="pull-left">
			<form action="" id="form1">
				...
				<input name="a" value="bind" type="hidden" />
				<input name="do" value="details" type="hidden" />
