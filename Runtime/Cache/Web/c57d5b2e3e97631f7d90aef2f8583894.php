...
<body>
    ...
    <div data-role="page" id="release">
        ...
        <div data-role="header" data-theme="a" data-position="fixed" data-tap-toggle="false">
            ...
            <h1 class="yousi_title">发布家教需求</h1>
        </div>
        <!-- //header end -->
                ...
                <li class="list_li">
                    <div class="ui-field-contain" >
                        ...
                        <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true">
                            <input type="radio" name="s_sex" id="radio-choice-c" value="list" checked="checked">
                            <label for="radio-choice-c">男生</label>
                            <input type="radio" name="s_sex" id="radio-choice-d" value="grid">
            ...
            <ul data-role="listview" data-inset="true" class="list" data-theme="c">
                    ...
                    <li class="list_li">
                        <div class="ui-field-contain" >
                            <label>主辅科目:</label>
                            <div id="subjectDiv">
                                <!--<fieldset id='subject' data-role="controlgroup" data-type="horizontal" data-mini="true">-->
                                    <!--<input type="checkbox" name="subject" id="radio-choicejy-aa" value="1">-->
                                    <!--<label for="radio-choicejy-aa">物理</label>-->
                                    <!--<input type="checkbox" name="subject" id="radio-choicejy-bb" value="2">-->
                                    <!--<label for="radio-choicejy-bb">数学</label>-->
                                    <!--<input type="checkbox" name="subject" id="radio-choicejy-cc" value="3">-->
                                    <!--<label for="radio-choicejy-cc">语文</label>-->
                                <!--</fieldset>-->
                            </div>
                    ...
                    <li class="list_li">
                        <div class="ui-field-contain">
                            ...
                            <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true">
                                <input type="checkbox" name="special" id="radio-choicejy-e" value="12">
                                <label for="radio-choicejy-e">竞赛辅导</label>
                                <input type="checkbox" name="special" id="radio-choicejy-f" value="14">
                                <label for="radio-choicejy-f">英语辅导</label>
                                <input type="checkbox" name="special" id="radio-choicejy-v" value="15">
                                <label for="radio-choicejy-v">汉语授课</label>
                            </fieldset>
                        </div>
                    </li>
                    ...
                    <li class="list_li">
                        <div class="ui-field-contain" >
                            <label >教员性别:</label>
                            <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true">
                                <input type="radio" name="t_sex" id="radio-choicejy-a" value="list" checked="checked">
                                <label for="radio-choicejy-a">不限</label>
                                <input type="radio" name="t_sex" id="radio-choicejy-b" value="grid">
                                <label for="radio-choicejy-b">男生</label>
                                <input type="radio" name="t_sex" id="radio-choicejy-c" value="grid">
                                <label for="radio-choicejy-c">女生</label>
                            </fieldset>
                        </div>
                    </li>
                    ...
                    <li class="list_li">
                        <div class="ui-field-contain" >
                            <label >加价(路途太远建议加价，增加选择率):</label>
                            <select name="addPrice" id="select-custom-jiajia">
                                <option>请选择</option>
                                <option value="1">不加价</option>
                                <option value="2">+5元/时</option>
                                <option value="3">+10元/时</option>
                                <option value="4">+15元/时</option>
                                <option value="5">+20元/时</option>
                                <option value="6">+25元/时</option>
                                <option value="7">+30元/时</option>
                            </select>
                        </div>
                    </li>
                    <li class="list_li">
                        <div class="ui-field-contain" >
                            <label >同时辅导:</label>
                            <select name="direct" id="select-custom-tongshi">
                    ...
                    <li class="list_li">
                        <div class="ui-field-contain">
                            <label>发布高校:</label>
                            <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true">
                                <input type="checkbox" name="school" id="radio-choicejy-t" value="list">
                                <label for="radio-choicejy-t">上海交通大学</label>
                                <input type="checkbox" name="school" id="radio-choicejy-y" value="grid">
                                <label for="radio-choicejy-y">华东理工大学</label>
                                <input type="checkbox" name="school" id="radio-choicejy-u" value="grid">
                                <label for="radio-choicejy-u">上海外国语大学</label>
                            </fieldset>
                        </div>
                    </li>
                    <li class="list_li">
                        <div class="ui-field-contain" >
                            <label for="textarea">详细需求:</label>
                            <textarea cols="40" rows="16" name="detail" id="textarea" ></textarea>
                        </div>
                    </li>
                    </ul>
                ...
                <ul data-role="listview" data-inset="true" class="list" data-theme="c">
                    <li class="list_li">
                        <div class="ui-field-contain" >
                            <label>签署公约:<a href="#contract">【查看公约】</a></label>
                            </div>
                                <div class="ui-radio">
                                <label for="radio-enhanced" class="ui-btn ui-corner-all ui-btn-inherit ui-btn-icon-left ui-radio-off">同意签署优思家教公约</label>
                                <input type="radio" name="parentConcat" id="radio-enhanced" data-enhanced="true">
                                 </div>

                    </li>
                </ul>
                <button class="ui-btn ui-corner-all" id="fabu_submit">确认提交订单</button>
    ...
    <!-- //家长公约-->
    <div data-role="dialog" id="contract" >
        <!-- //header -->
        <div data-role="header" data-position="fixed" data-tap-toggle="false">
            <h1 class="yousi_title">家长公约</h1>
        </div>
        <!-- //header -->
...
<script type="text/javascript" src="/lib/js/web/release.js"></script>
...
<script type="text/javascript">
    require(['lib/js/web/release'], function (app) {
