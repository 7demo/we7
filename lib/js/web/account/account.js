define('lib/js/web/account/account', ['require', 'jquery', 'lib/js/web/common/ys_core', 'lib/js/web/common/countDown', 'lib/js/web/common/ajax', 'lib/js/web/init', 'lib/components/jquerymobile/jquery.mobile-1.4.5.min'],function (require){
	//引入jquery与jquerymobile

	var $ = require('jquery'),
        yousi_tool = require('lib/js/web/common/ys_core'),
        countDown = require('lib/js/web/common/countDown'),
        ajax = require('lib/js/web/common/ajax');
	require('lib/js/web/init');
	require('lib/components/jquerymobile/jquery.mobile-1.4.5.min');
    /*
    *
    * 登录
    *
